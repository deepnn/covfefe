...
import lasagne.init as L

def uniform(range=0.01, std=None, mean=0.0):
    ...
    """
	return L.Uniform(range, std, mean)


def normal(std=0.01, mean=0.0):
    ...
    """
	return L.Normal(std, mean)

def glorot_normal(gain=1.0, c01b=False):
    ...
    .. math::
       ...
       W &\sim N(0, \\sigma)
    """
    return L.GlorotNormal(gain, c01b)


def glorot_uniform(gain=1.0, c01b=False):
    ...
    .. math::
       ...
       W &\sim U[-a, a]
    """
    return L.GlorotUniform(gain, c01b)


def he_normal(gain=1.0, c01b=False):
    ...
    """
    return L.HeNormal(gain, c01b)


def he_uniform(gain=1.0, c01b=False):
...
def orthogonal(gain):
    ...
    """
    return L.Orthogonal(gain)

def constant(val=0.0):
    ...
    """
	return L.Constant(val)

def sparse(sparsity=0.1, std=0.01):
